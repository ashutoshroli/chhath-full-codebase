// Ported verbatim from mgmt/frontend/src/imagePrep.js — reads an image file,
// downscales it to a max dimension and re-encodes as JPEG for upload (GIFs and
// undecodable files are passed through as-is, subject to a max byte limit).
