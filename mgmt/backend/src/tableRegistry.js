...
export const TABLE_REGISTRY = {
  ...
  'official_emails': { db: 'whatsapp_index', table: 'official_emails' },
...
export const COLUMN_ALIASES = {
  ...
  users: { 'ID': 'id_code', 'Name': 'name', 'Village': 'village', "Father's Name": 'fathers_name', 'Mobile': 'mobile', 'Designation': 'designation', 'Created By': 'created_by', 'Email': 'email', 'WhatsApp': 'whatsapp', 'Name (Hindi)': 'name_hindi', "Father's Name (Hindi)": 'fathers_name_hindi', 'Designation (Hindi)': 'designation_hindi', 'Village (Hindi)': 'village_hindi', 'Photo': 'photo' },
