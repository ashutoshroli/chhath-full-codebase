...
export const api = {
  ...
  setPortalSettings: (settings) => call('setPortalSettings', { settings }),
  ...
  sendCustomPush: (title, body, url) => call('sendCustomPush', { title, body, url }),
  listPushSubscriptions: (limit) => call('listPushSubscriptions', { limit }),
