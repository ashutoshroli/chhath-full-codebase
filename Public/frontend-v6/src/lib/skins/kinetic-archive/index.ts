...
import KineticShell from './KineticShell.svelte';
...
export const kineticArchiveSkin: Skin={id:'kinetic-archive',Shell:KineticShell,pages:{Home,Expenses,Loans,Committee,Downloads,Decade,Donate,Verify}};
