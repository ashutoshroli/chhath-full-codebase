<script lang="ts">
  ...
  import '$lib/skins/surya-ghat/Readability.css';
...
<div class="surya-shell min-h-screen" style="--surface-bg: 12 31 42; --surface-alpha: .96; --surface-border: 230 166 67; --surface-border-alpha: .22; --accent: 230 166 67; --accent-2: 76 198 194; --fest-ink: 235 244 241; --fest-pos: 110 231 183; --fest-banner-from: #061822; --fest-banner-to: #07515a;">
